...
<html lang="en">
<head>
    <link rel="amphtml" href="http://localhost/amp/contact.amp.php">
    <meta charset="UTF-8">
...
<div class="background">
 ...
 <h2>İLETİŞİM</h2>
    ...
    <p><span id="iletisimlo" >iletisim@SİTE.com</span> mail adresinden bizimle iletişime geçebilirsiniz.</p>
    <p>gmail,hotmail,protonmail vb. gibi ücretsiz e-posta servisleri aracılığıyla gönderilen mailler tarafımıza ulaşmaz ve geri dönüş yapılmaz. Lütfen yalnızca kurumsal e-posta adresiniz aracılığıyla mail gönderiniz (email@yourdomain.com vb.)</p>
    </div>
    <br>
