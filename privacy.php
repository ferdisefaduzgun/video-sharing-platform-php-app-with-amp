...
<html lang="en">
<head>
    <link rel="amphtml" href="http://localhost/amp/privacy.amp.php">
    <meta charset="UTF-8">
...
<div class="background">
    ...
    <p>
 internet sitemiz ziyaretçilerimizin hiçbir zaman, hiçbir şekilde, hiçbir bilgisini barındırmaz, kaydetmez ve saklamaz. Ziyaretçilerimizden internet sitemizde gezinmeye başladığı andan, çıkış yaptığı ana kadar hiçbir bilgisini (ad, soyad, e-posta adresi, şifre gibi) istemeyiz.
</p>

<p>Dolayısıyla ziyaretçilerimizden elimize düşen hiçbir bilgi olmamaktadır. Bu sebeple üçüncü kişiler veya taraflar ile paylaşacak herhangi bir log, data, kayıt bizde de bulunmamaktadır.
</p>

    <p>Websitemiz herhangi bir bilgiyi, kaynağı, belgeyi veya bir materyali kuruluşlar, kurumlar ve kişiler ile paylaşmaz. Çünkü elimizde herhangi bir veri bulunmamaktadır. Verileri saklama zorunluluğumuzun olmaması, hatta kullanıcı verilerini kaydetmemizin yasak olmasının nedeni ise; websitemizin yer sağlayıcı olarak görev yapmasıdır.



</p>

<p> Websitemiz bu sebeplerden dolayı en güvenli film sitesidir. Bizim hiçbir bilgiyi kayıt etmiyor oluşumuz, diğer sitelerinde kayıt etmediği anlamına gelmiyor. Bu sebeple, sitemizi kullanmaya devam etmeniz güvenliğiniz açısından sizler adına çok daha iyi olacaktır.

</p>

<p>Tüm politikalarımızı okuduğunuza göre keyifle film izlemeye devam edebilirsiniz.</p>
